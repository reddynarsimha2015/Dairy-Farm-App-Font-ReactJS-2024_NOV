...
const EditProduct=()=>{
  ...
  console.log(`param   :${productid}`);
   ...
   let serverProduct=response.data;
   console.log(serverProduct);
   setProduct({
    productname:serverProduct.productname,
        price: serverProduct.price,
        imageUrl: serverProduct.imageUrl,
        energy: serverProduct.energy,
        fat: serverProduct.fat,
        protien: serverProduct.protien,
        nuriationalinfo: serverProduct.nuriationalinfo
   })
      }
      catch(e){
        console.log(e);
